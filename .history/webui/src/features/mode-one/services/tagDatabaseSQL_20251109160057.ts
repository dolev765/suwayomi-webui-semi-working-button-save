...
const getInitSqlJs = async () => {
    if (!initSqlJs) {
        ...
        // sql.js exports the init function in different ways depending on the build
        ...
        if (typeof initSqlJs !== 'function') {
            console.error('sql.js import error: Expected function, got:', typeof initSqlJs, module);
            throw new Error('Failed to load sql.js: init function not found');
        }
    }
    return initSqlJs;
};
