...
export const ModeOneFilterPanel = ({
    ...
    // Lewd, enticing, and warm placeholders - different for male and female
    // Rules: No fourth wall breaks, no judgment, no pressure, no asking what they like
    const femaleTagPlaceholders = useMemo(() => [
        'Find what gets wet...',
        'Discover what drips...',
        'Search for deepest desires...',
        'Explore what makes cum...',
        'Find what turns on most...',
        'Discover wildest fantasies...',
        'Search for pure pleasure...',
        'Find what throbs...',
        'Explore darkest cravings...',
        'Discover what drives wild...',
        'Find what aches...',
        'Search for ultimate satisfaction...',
        'Find what leaks...',
        'Discover secret desires...',
        'Explore what makes moan...',
        'Find what gets going...',
        'Discover what throbs...',
        'Search for intense pleasure...',
        'Find what makes desperate...',
        'Explore deepest needs...',
        'Discover what weakens...',
        'Find what drives crazy...',
        'Search for raw desire...',
        'Find what burns...',
        'Discover forbidden wants...',
        'Explore what makes needy...',
        'Find what makes beg...',
        'Search for complete ecstasy...',
        'Find what loses control...',
        'Discover primal urges...',
        'Explore what melts...',
        'Find what squirms...',
        'Search for overwhelming pleasure...',
        'Find what makes desperate...',
        'Discover what writhes...',
        'Explore carnal desires...',
        'Find what surrenders...',
        'Search for mind-blowing pleasure...',
        'Find what comes undone...',
        'Discover deepest lust...',
        'Explore what quivers...',
        'Find what breaks...',
        'Search for pure ecstasy...',
        'Find what trembles...',
        'Discover wildest needs...',
        'Explore what aches...',
        'Find what yearns...',
        'Search for intense satisfaction...',
        'Find what pulses...',
        'Discover burning desires...',
        'Explore what throbs...',
        'Find what craves...',
        'Search for complete bliss...',
        'Find what makes desperate...',
        'Discover secret cravings...',
        'Explore what makes needy...',
        'Find what wants more...',
        'Search for ultimate release...',
        'Find what loses self...',
        'Discover deepest needs...',
        'Explore what burns...',
        'Find what surrenders...',
        'Search for raw passion...',
        'Find what makes desperate...',
        'Discover forbidden desires...',
        'Explore what weakens...',
        'Find what comes alive...',
        'Search for pure lust...',
        'Find what breaks down...',
        'Discover primal needs...',
        'Explore what melts...',
        'Find what squirms...',
        'Search for overwhelming desire...',
        'Find what writhes...',
        'Discover carnal cravings...',
        'Explore what surrenders...',
        'Find what comes undone...',
        'Search for mind-blowing ecstasy...',
        'Find what loses control...',
        'Discover deepest lust...',
        'Explore what quivers...',
        'Find what breaks...',
        'Search for pure pleasure...',
        'Find what trembles...',
        'Discover wildest wants...',
        'Explore what aches...',
        'Find what yearns...',
        'Search for intense release...',
        'Find what pulses...',
        'Discover burning needs...',
        'Explore what throbs...',
        'Find what craves...',
        'Search for complete satisfaction...',
        'Find what makes desperate...',
        'Discover secret wants...',
        'Explore what makes needy...',
        'Find what wants more...',
        'Search for ultimate pleasure...',
        'Find what loses self...',
        'Discover deepest desires...',
        'Explore what burns...',
        'Find what surrenders...',
        'Search for raw ecstasy...',
        'Find what makes desperate...',
        'Discover forbidden needs...',
        'Explore what weakens...',
        'Find what comes alive...',
        'Search for pure desire...',
    ], []);

    const maleTagPlaceholders = useMemo(() => [
        'Find what makes hard...',
        'Discover what gets off...',
        'Search for deepest desires...',
        'Explore what makes cum...',
        'Find what turns on most...',
        'Discover wildest fantasies...',
        'Search for pure pleasure...',
        'Find what makes throb...',
        'Explore darkest cravings...',
        'Discover what drives wild...',
        'Find what makes ache...',
        'Search for ultimate satisfaction...',
        'Find what makes leak...',
        'Discover secret desires...',
        'Explore what makes moan...',
        'Find what gets going...',
        'Discover what makes throb...',
        'Search for intense pleasure...',
        'Find what makes desperate...',
        'Explore deepest needs...',
        'Discover what makes weak...',
        'Find what drives crazy...',
        'Search for raw desire...',
        'Find what makes burn...',
        'Discover forbidden wants...',
        'Explore what makes needy...',
        'Find what makes beg...',
        'Search for complete ecstasy...',
        'Find what makes lose control...',
        'Discover primal urges...',
        'Explore what makes melt...',
        'Find what makes squirm...',
        'Search for overwhelming pleasure...',
        'Find what makes desperate...',
        'Discover what makes writhe...',
        'Explore carnal desires...',
        'Find what makes surrender...',
        'Search for mind-blowing pleasure...',
        'Find what makes come undone...',
        'Discover deepest lust...',
        'Explore what makes quiver...',
        'Find what makes break...',
        'Search for pure ecstasy...',
        'Find what makes tremble...',
        'Discover wildest needs...',
        'Explore what makes ache...',
        'Find what makes yearn...',
        'Search for intense satisfaction...',
        'Find what makes pulse...',
        'Discover burning desires...',
        'Explore what makes throb...',
        'Find what makes crave...',
        'Search for complete bliss...',
        'Find what makes desperate...',
        'Discover secret cravings...',
        'Explore what makes needy...',
        'Find what makes want more...',
        'Search for ultimate release...',
        'Find what makes lose self...',
        'Discover deepest needs...',
        'Explore what makes burn...',
        'Find what makes surrender...',
        'Search for raw passion...',
        'Find what makes desperate...',
        'Discover forbidden desires...',
        'Explore what makes weak...',
        'Find what makes come alive...',
        'Search for pure lust...',
        'Find what makes break down...',
        'Discover primal needs...',
        'Explore what makes melt...',
        'Find what makes squirm...',
        'Search for overwhelming desire...',
        'Find what makes writhe...',
        'Discover carnal cravings...',
        'Explore what makes surrender...',
        'Find what makes come undone...',
        'Search for mind-blowing ecstasy...',
        'Find what makes lose control...',
        'Discover deepest lust...',
    ...
    const [femalePlaceholderIndex, setFemalePlaceholderIndex] = useState(0);
    const [malePlaceholderIndex, setMalePlaceholderIndex] = useState(0);

    // Change placeholder when filter panel opens
    useEffect(() => {
        if (open) {
            // Pick random placeholders for both when panel opens
            setFemalePlaceholderIndex(Math.floor(Math.random() * femaleTagPlaceholders.length));
            setMalePlaceholderIndex(Math.floor(Math.random() * maleTagPlaceholders.length));
        }
    }, [open, femaleTagPlaceholders.length, maleTagPlaceholders.length]);

    // Helper to get placeholder based on filter label
    const getTagPlaceholder = (filterLabel: string): string => {
        const label = filterLabel.toLowerCase();
        if (label.includes('female')) {
            return femaleTagPlaceholders[femalePlaceholderIndex];
        } else if (label.includes('male')) {
            return maleTagPlaceholders[malePlaceholderIndex];
        }
            ...
            case 'text':
                control = (
                    <TextFilterControl
                        ...
                        placeholder={TAG_FILTER_LABEL_PATTERN.test(filter.label) ? getTagPlaceholder(filter.label) : placeholderText}
                        label={filter.label}
