import { MODE_ONE_QUERY_FALLBACK_SOURCES, ModeOneSourceKey } from '@/features/mode-one/ModeOne.types.ts';
...
export const SOURCE_CONFIG: Array<{ key: ModeOneSourceKey; matchers: string[] }> = [
    ...
    { key: 'hentaiera', matchers: ['hentaiera', 'hentai-era', 'hentai era'] },
    { key: 'imhentai', matchers: ['imhentai', 'im-hentai', 'im hentai'] },
    { key: 'nhentai', matchers: ['nhentai', 'n-hentai', 'n hentai'] },
];
