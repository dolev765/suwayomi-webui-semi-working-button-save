...
import { ensureDatabaseReady, testDatabaseSearch } from '@/features/mode-one/services/tagDatabaseSQL.ts';
        ...
        void (async () => {
            try {
                ...
                if (isReady && process.env.NODE_ENV === 'development') {
                    // Test database in development mode
                    testDatabaseSearch('milf');
                }
            } catch (error) {
