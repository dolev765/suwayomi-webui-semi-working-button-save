...
export type ModeOneSourceKey = 'hentai2read' | 'hitomi' | 'ehentai' | 'hentaifox' | 'hentaiera' | 'imhentai' | 'nhentai';
...
export type ModeOneFilterPayload = {
    ...
    tagSearchMode?: 'and' | 'or' | 'hybrid';
    // For progressive tag search
    tagCombinations?: Array<{
        tags: string[];
        omittedTags: string[];
        query: string;
    }>;
    currentTagCombinationIndex?: number;
};
