...
export function BaseMangaGrid(
    props: Omit<IMangaGridProps, 'mangas'> & {
        mangas: TMangaBaseGrid[];
    ...
    return (
        <MangaGrid
            ...
            {...props}
            mangas={mangas as IMangaGridProps['mangas']}
            mangaWarnings={props.mangaWarnings}
        />
    );
}
