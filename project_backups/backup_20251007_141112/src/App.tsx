...
const { ModeOne } = loadable(() => import('@/features/mode-one/screens/ModeOne.tsx'), lazyLoadFallback);
        ...
        >
            <ErrorBoundary>
                <Routes>
                    ...
                    <Route path={AppRoutes.modeOne.match} element={<ModeOne />} />
