...
export const ModeOne = () => {
    ...
    const [panelSelectionDraft, setPanelSelectionDraft] = useState<ModeOneFilterSelection>({});
    const [panelQueryDraft, setPanelQueryDraft] = useState('');
    const [panelStrictOnlyDraft, setPanelStrictOnlyDraft] = useState(false);
